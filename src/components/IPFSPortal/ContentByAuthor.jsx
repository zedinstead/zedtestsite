  ...
  setPDF(e.target.value)
    ...
    let PDFs = [ 
        ...
        },
        {
            label: "-------------------------|",
            author: "|-------------------------",
            date: "PERIODICALS SECTION",
            value: "https://ipfs.io/ipfs/Qmbw6eQmVnanjhGrmMpbEhCqnnFAxMRh6CoPp6SiF4nzhY?filename=EasterEgg.pdf",
            status: "active",
            url: ""
        },
        {
...
<div> 
    <select onChange={handlePDFChange}> 
        ...
        {PDFs.map((PDF) => <option value={PDF.value}>{PDF.author}&nbsp;|&nbsp;{PDF.date}&nbsp;|&nbsp;{PDF.label}</option> )}
        </select>
...
export default ContentByAuthor;
